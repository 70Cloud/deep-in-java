 ...
 * @Author: NoNo
 * @Description: 类对象示例代码
 * @Date: Create in 8:47 2019/7/8
 */
public class ClassObjectDemo {

    public static void main(String[] args) {
        // ClassLoader 在加载类过程（验证）中，去重操作
        // 验证：运行时校验 .class 文件（已经编译的结果）
        // .class 文件版本 Java 5 泛型，JVM 版本过低版本不兼容
        // 处理：参考《深入理解 Java 虚拟机》第二版
        // 双亲委派（类加载以及类存储）
        ...
        // 除 Bootstrap ClassLoader 之外，还有 System ClassLoader, Application ClassLoader
    }
