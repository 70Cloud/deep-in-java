 ...
 * @Author: NoNo
 * @Description:
 * @Date: Create in 23:39 2019/1/17
 */
public class IntegerDemo {
    ...
    public static void main(String[] args) {
        ...
        // 问：如何不改代码，上面的结果都返回 false？
        // 答：通过调整java.lang.Integer.IntegerCache.high参数
        // JAVA_OPTS="-Djava.lang.Integer.IntegerCache.high=50" 还是 -XX:AutoBoxCacheMax=<size> ？
    }
}
